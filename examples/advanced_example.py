#!/usr/bin/env python3
"""
Advanced example demonstrating LiteLLM integration with consensus system.

This example shows how to use LiteLLM-backed agents for actual LLM execution
...
from consensus_system.litellm_agent import create_litellm_agents_from_config
...
def main():
    ...
    print("Multi-Agent Consensus System - Advanced Example (LiteLLM)")
    print("=" * SEPARATOR_WIDTH)
    ...
    print("\n2. Creating LiteLLM-backed consensus agents...")
    ...
    if isinstance(consensus_value, (int, float)):
        if consensus_value < 3.0:
            ...
            symbol = "✗"
            recommendation = (
                "Immediate attention required. Multiple agents identified serious problems."
            )
